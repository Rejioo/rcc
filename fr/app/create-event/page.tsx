                ...
                <div className="grid gap-3">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select required>
                      ...
                      <SelectContent>
                        <SelectItem value="mountain">Mountain Biking</SelectItem>
                        <SelectItem value="road">Road Cycling</SelectItem>
                        <SelectItem value="cross">Cross-Country</SelectItem>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  <div className="grid gap-2">
                    ...
                    <Input id="location" placeholder="e.g. Central Park, Blue Ridge Mountains" required />
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="elevation" type="number" min="0" placeholder="Enter elevation gain" />
                  </div>
