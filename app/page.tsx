...
const events = [
  {
    ...
    description: "A casual ride and meet up to yelagiri",
  },
  {
    id: 2,
    title: "Mercury Ducati Ride",
    date: "March 30, 2025",
    location: "MDK",
    type: "road",
    participants: 120,
    image: "/placeholder.svg?height=200&width=400",
    description: "A thrill chill ride till Mudaliayar Kuppam to meet team ducati",
  },
  {
    id: 3,
    title: "Charity cruise",
    date: "June 10, 2025",
    location: "bangalore",
    type: "Road",
    participants: 75,
    image: "/placeholder.svg?height=200&width=400",
    description: "A fundraising ride to support local environmental initiatives.",
  },
  {
    id: 4,
    title: "Madras Driven",
